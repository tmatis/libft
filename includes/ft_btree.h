...
#define DEFINE_BTREE_HEADERS(type)                                                                    \
    ...
    void btree_##type##_foreach_arg(btree_##type##_node *root, void (*f)(type *, void *), void *arg); \
...
#define DEFINE_BTREE_FUNCTIONS(type, cmp)                                                                    \
    ...
    {                                                                                                        \
        if (root == NULL)                                                                                    \
            return;                                                                                          \
        btree_##type##_foreach_arg(root->left, f, arg);                                                      \
        f(&root->value, arg);                                                                                \
        btree_##type##_foreach_arg(root->right, f, arg);                                                     \
    }                                                                                                        \
                                                                                                             \
    void btree_##type##_delete(btree_##type##_node **root, type *value)                                      \
    {                                                                                                        \
